{{--
  ...
  <p>Blijf op de hoogte over nieuwe verhalen van vroeger in de app, over nieuwe mogelijkheden in de huidige app of over volledig nieuwe diensten om de band met personen met dementie te versterken.</p>

  <!-- Begin MailChimp Signup Form -->

  <div id="mc_embed_signup" class="my-4">
    <form action="//care.us16.list-manage.com/subscribe/post?u=b4918c79c09994c5be2d9d92e&amp;id=9e7f8f5b18" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate form-inline justify-content-md-center" target="_blank" novalidate>
